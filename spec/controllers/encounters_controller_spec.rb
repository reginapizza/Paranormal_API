...
RSpec.describe EncountersController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new encounter" do

        post :create, params: {encounter: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(encounter_url(Encounter.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new encounter" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the encounter" do
        encounter = Encounter.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the encounter" do
        encounter = Encounter.create! valid_attributes
